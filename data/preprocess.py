        ...
        if isinstance(obj, dict):
            ...
            for key, value in obj.items():
                ...
                if isinstance(value, str):
                    ...
                    node_timestamps.append(entity_timestamp)
                    ...
                    for i, item in enumerate(value):
                        ...
                        if isinstance(item, (dict, list)):
                            node_features.append(key)
                            node_timestamps.append(item_timestamp)
                            current_node_id = node_counter
...
if __name__ == "__main__":
    ...
    with open(jsonl_file_path, 'r', encoding='utf-8') as f:
        json_lines = [str(line) for line in f if line.strip()]
    ...
    for row_idx in range(len(json_lines)):
        ...
        entity_id = json_data.get(id_key)
    ...
    for graph_info in all_graphs_data:
        ...
        graph_data.entity_id = graph_info['entity_id']
    ...
    torch.save(dataset, os.path.join(output_path, 'graph_dataset.pt'))
